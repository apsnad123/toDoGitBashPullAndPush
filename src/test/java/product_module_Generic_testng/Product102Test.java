package product_module_Generic_testng;
...
import com.crm.CAH.Object_Repository.DublicatingProduct_page;
import com.crm.CAH.Object_Repository.EditProduct_page;
...
public class Product102Test extends BaseClass {

	
	@Test(groups = {"regression","integration"})
	public void DublicatingProduct() throws IOException, InterruptedException {
  ...
  //switching window  
   ...
   //switching back to window 
    ...
    //Duplicate the saved product
    ProductDetailView_page productDetailViewPage = new ProductDetailView_page(driver);
    productDetailViewPage.duplicating();
          
          DublicatingProduct_page DublicatingProductPage = new DublicatingProduct_page(driver);
          DublicatingProductPage.DublicatingProductSave();
	    }
	//.................................................................................
	...
	@Test(groups = {"regression","integration","system"})
	public void EditingProduct() throws IOException, InterruptedException {
  ...
  //switching window  
   ...
   //switching back to window 
    ...
    ProductDetailView_page productDetailViewPage = new ProductDetailView_page(driver);
             productDetailViewPage.editing();
            
             EditProduct_page editProductPage = new EditProduct_page(driver);
             editProductPage.editingProductMandotoryField(wUtil, driver, random_product_name);
            
                           
	     }
	
	@Test(groups = {"regression","integration","system"})
	public void SearchingTheCreatedProduct() throws IOException, InterruptedException {
   ...
   //switching back to window 
    ...
    createProductPage.fillingProductField(Vendor_Part_No, Product_Sheet, wUtil, GL_Account, Part_Number, ran, Website, Serial_No, Commission_Rate, Usage_Unit, Qty_in_Stock, Qty_Unit, Reorder_Level, Qty_in_Demand, Description);
               ...
               //search for the created product
        		...
        		productPage.validateTheProduct(random_product_name, wUtil, driver, In);
