...
public class SearchingTheCreatedProduct_GenericUtilsTest extends BaseClass {
...
//        		}
        		//Assert.assertEquals(nameOfResultendProduct, random_product_name, "Fail: the product has not been created");
	            SoftAssert soft = new SoftAssert();  
	            soft.assertEquals(nameOfResultendProduct, random_product_name, "Fail: the product has not been created");
	            soft.assertAll();
	                                }
